...
public interface CourseRepository extends JpaRepository<Course, String> {
  @Query(
      "select c from Course c where " +
          ...
          "lower(c.mainTeacher.firstName) like concat('%', lower(:teacher_first_name), '%') and " +
          "lower(c.mainTeacher.lastName) like concat('%', lower(:teacher_last_name), '%') and " +
          "(:credits is null or c.credits = :credits)")
  List<Course> findAllByCriteria(@Param("code") String code, @Param("name") String name,
